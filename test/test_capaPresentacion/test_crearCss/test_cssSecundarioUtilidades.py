...
def test_bicisStylesCss():
  bicis =  '''#contenedorPadre {
  display: flex;
...
'''
  assert bicisStylesCss() == bicis


@pytest.mark.test_bicisfiltroStylesCss
def test_bicisfiltroStylesCss():
  bicisFiltro = '''#contenedorPadre {
     display: flex;
     justify-content: center;
     align-items: center;
     flex-wrap: wrap;
...
'''
  assert bicisfiltroStylesCss() == bicisFiltro


@pytest.mark.test_biciSolitariaStylesCss
def test_biciSolitariaStylesCss():
  bicisolitaria = '''
  .titleBicis{
    text-align:center;
    font-size: 50px;
...
'''
  assert biciSolitariaStylesCss() == bicisolitaria


@pytest.mark.test_marcasStylesCss
def test_marcasStylesCss():
  marcas ='''
#container{
  position: relative;
  text-align: center;
...
'''
  assert marcasStylesCss() == marcas


@pytest.mark.test_rentalsStylesCss
def test_rentalsStylesCss():
  rentals = '''
.rentals {
    display: flex;
    justify-content: center;
...
'''
  assert rentalsStylesCss() == rentals

@pytest.mark.test_tiposStylesCss
def test_tiposStylesCss():
  tipos = '''.contenedor{
  display: flex;
  align-items: center;
}
